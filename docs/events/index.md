...
title: Events
description: Use Fabric API's event system to encourage mod compatability and reduce the amount of mixins you write.
...
grid_navigation:
    - title: Using Fabric API Events
      excerpt: Learn how to use Fabric API's event system.
      cta: Read more
      url: '/events/usage' 
    - title: Creating Your Own Events
      excerpt: Learn how to create your own events, to allow compatability with other mods.
      cta: Read more
      url: '/events/creation'
---
