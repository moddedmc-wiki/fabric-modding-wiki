...
<Download type="textures" href="/blocks/condensed_oak_log_textures.zip" />
...
- Why don't you try and implement the same functionality using [Block Entities](/blocks/block-entities)
