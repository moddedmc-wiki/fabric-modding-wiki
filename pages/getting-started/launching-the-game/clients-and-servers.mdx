...
<Callout type="info">This topic is a continuation of the [Launching the Game](/getting-started/launching-the-game) page.</Callout>
...
<Callout type="warning">Keep in mind that all instances have their own directory now! You will have to install the same mods and change the same settings serveral times now.</Callout>
