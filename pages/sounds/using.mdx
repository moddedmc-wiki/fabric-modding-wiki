...
- Already familiar with [Mixins](/getting-started/mixins)? Try to lower the pitch of the Bell Block in the `BellBlock` class and increase the sound's distance too.