...
```java
public class TestBlockEntity extends BlockEntity {
    // implementing a Property for the object's custom data
...
```java
public class TestBlockEntity extends BlockEntity {
    // the new attribute for the ticking
...
<!--
TODO: 
   - inform client of the data when adding custom rendering (like text on signs) using toUpdatePacket and toInitialChunkDataNbt 
   - custom inventories
   - connection to the ScreenHandler topic for container blocks
 -->
